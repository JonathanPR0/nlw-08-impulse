    ...
    <>
      <header>
        ...
        <span className="text-xl leading-6 flex items-center gap-2">
          <img src={feedbackTypeInfo.image.source} alt={feedbackTypeInfo.image.source} /> {feedbackTypeInfo.title}
        </span>
        <CloseButton />
      </header>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            className="p-2 bg-brand-500 rounded-md border-tranparent flex-1 flex justify-center items-center text-sn hover:bg-brandHover-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500">
            Enviar Feedback
          </button>
        </footer>
      </form>
